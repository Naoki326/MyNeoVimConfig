return {
    ...
    keys = {
        { "<leader>bb", function() require("browse").browse() end, desc = "Browse" },
        { "<leader>bs", function() require("browse").input_search() end, desc = "Browse Search" },
        { "<leader>bm", function() require("browse").open_bookmarks() end, desc = "Browse Bookmarks" },
    },
}
